...
[![CI Pipeline](https://github.com/EliBarton/jwt-pizza/actions/workflows/ci.yml/badge.svg)](https://github.com/EliBarton/jwt-pizza/actions/workflows/ci.yml)
...
`JWT Pizza` takes the next stage of digital evolution by allowing you to buy pizzas that you will never actually eat. Not only does JWT exchange bitcoin and give you nothing in return, it also allows for you to be come a franchisee and turn the whole vapor company into an MLM.
